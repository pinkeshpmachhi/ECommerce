...
fun CartScreen(
    ...
    fun deteleFromCartFunction(product :SmartphoneCatModel){
        myViewModel.deletToCart(product = product)
        Toast.makeText(cont,"Removed from cart successfully",Toast.LENGTH_LONG).show()
    }
    ...
    SwipeRefresh(
        ...
        if (myViewModel.cartProcessBool && myViewModel.userDataBool){
            ...
            Column(
                ...
                LazyColumn{
                    ...
                    myViewModel.getCartProduct().forEach {
...
//                            if (myViewModel.justBool)
                            ...
                            Row(modifier = modifier
                                ...
                                Column(
                                    ...
                                    Button(onClick = { deteleFromCartFunction(product = it) },
                                        modifier = modifier
                                            .fillMaxWidth()
                                            .padding(4.dp),
